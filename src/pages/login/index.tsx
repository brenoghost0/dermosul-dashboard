...
export default function Login() {
  ...
  return (
    <div style={{minHeight:"100vh",display:"grid",placeItems:"center",background:"#f7f5ef"}}>
      <form onSubmit={submit} style={{background:"#fff",padding:"24px",borderRadius:"12px",boxShadow:"0 6px 24px rgba(0,0,0,.08)",width:"100%",maxWidth:"360px"}}>
        ...
        <input value={user} onChange={e=>setUser(e.target.value)} placeholder="admin" style={{width:"100%",padding:"10px",margin:"6px 0 12px",border:"1px solid #ddd",borderRadius:"8px"}} />
        <label style={{display:"block",fontSize:"14px"}}>Senha</label>
        <input type="password" value={pass} onChange={e=>setPass(e.target.value)} style={{width:"100%",padding:"10px",margin:"6px 0 16px",border:"1px solid #ddd",borderRadius:"8px"}} />
